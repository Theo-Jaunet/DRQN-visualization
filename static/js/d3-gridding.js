...
(function (global, factory) {
...
}(this, (function (exports, d3Scale, d3Array, d3Hierarchy, d3Shape) {
    'use strict';
    ...
    var coordinate = function (nodes, v) {
        ...
        var _valueX, _valueXmax, _valueXmin;
        ...
        if (!v.valueX) {
            ...
            _valueXmin = d3Array.min(nodes, _valueX);
        } else {
            _valueX = v.valueX;
            _valueXmax = d3Array.max(nodes, _valueX);
            _valueXmin = d3Array.min(nodes, _valueX);
        }
        console.log(_valueXmin)
        v.x.domain([_valueXmin - 0.3, _valueXmax+0.3]).range([0, v.size[0]]);
        ...
        v.y.domain([_valueYmax, 0]).range([0, v.size[1]]);

        var _valueWidth;

        if (!v.valueWidth) {
            _valueWidth = function () {
                return 1;
            };
    ...
    var pack$1 = function (nodes, v) {
        ...
        if (!v.valueWidth) {
            _valueWidth = function (_, i) {
                return packed.children[i].r;
            };
            v.width.domain([0, 1]).range([0, 1]);
        } else if (typeof v.valueWidth === "number") {
            _valueWidth = function () {
    ...
    var stack$1 = function (nodes, v) {
        ...
        var stack$$1 = d3Shape.stack()
            .keys(nodes.map(function (d, i) {
                return i + "_";
            })) // Creates unique ids for nodes
            .order(d3Shape.stackOrderDescending)
            .value(function (d, key) {
                return nodes.indexOf(d[key]);
            });
    ...
    var treemap$1 = function (nodes, v) {
        ...
        var root = stratify$$1(nodes.concat(extra))
            .sum(function (d) {
                return d.___parent_id === "" ? 0 : 1;
            });

        if (v.valueHeight) {
            root.sum(function (d) {
                return v.valueHeight(d);
            });
        }
    ...
    var gridding = function () {
        ...
        gridding.valueHeight = function (_valueHeight) {
            ...
            if (typeof _valueHeight === "string") {
                vars.valueHeight = function (d) {
                    return d[_valueHeight];
                };
            } else {
        ...
        gridding.valueWidth = function (_valueWidth) {
            ...
            if (typeof _valueWidth === "string") {
                vars.valueWidth = function (d) {
                    return d[_valueWidth];
                };
            } else {
